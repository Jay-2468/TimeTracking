...
<nav
	...
	<div
		...
		<a class="navbar-brand brand-logo" href="/developer-dashboard"><h2
	...
	<div class="navbar-menu-wrapper d-flex align-items-stretch">
		...
		<ul class="navbar-nav navbar-nav-right">
			<li class="nav-item  dropdown d-none d-md-block"><a
				...
				<div class="dropdown-menu navbar-dropdown"
					...
					<a class="dropdown-item" href="#"> <i
						class="mdi mdi-file-pdf-box me-2"></i>PDF
					</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="#"> <i
						class="mdi mdi-file-excel me-2"></i>Excel
					</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="#"> <i
						class="mdi mdi-file-word me-2"></i>doc
					</a>
				</div></li>
			<li class="nav-item  dropdown d-none d-md-block"><a
				...
				<div class="dropdown-menu navbar-dropdown"
					...
					<a class="dropdown-item" href="#"> <i
						class="mdi mdi-eye-outline me-2"></i>View Project
					</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="#"> <i
			...
			<li class="nav-item nav-language dropdown d-none d-md-block"><a
