<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
			...
			<div class="collapse" id="ui-basic">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link" href="newUser">Add
							New User</a></li>
					<li class="nav-item"><a class="nav-link" href="userList">List
							Users</a></li>
				</ul>
			</div></li>
		...
		<li class="nav-item"><a class="nav-link"
			...
			aria-controls="ui-basic"> <span class="icon-bg"><i
					class="mdi mdi-crosshairs-gps menu-icon"></i></span> <span
				class="menu-title">Manage Projects</span> <i class="menu-arrow"></i>
		</a>
			<div class="collapse" id="ui-basic">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link" href="newProject">Add
							New Project</a></li>
					<li class="nav-item"><a class="nav-link" href="projectList">List
							Projects</a></li>
				</ul>
			</div></li>
			...
			<div class="collapse" id="ui-basic">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link" href="newTask">Add
							New Task</a></li>
					<li class="nav-item"><a class="nav-link" href="taskList">List
							Tasks</a></li>
				</ul>
			</div></li>
